...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $pdo->prepare("
            UPDATE products 
            SET nama = ?, deskripsi = ?, harga = ?, harga_reseller = ?, 
                stok = ?, kategori = ?, foto = ?
            WHERE id = ?
        ");
        
        $stmt->execute([$nama, $deskripsi, $harga, $harga_reseller, $stok, $kategori, $foto, $product_id]);
    ...
    <form action="" method="POST" enctype="multipart/form-data" class="product-form">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="<?php echo htmlspecialchars($product['nama']); ?>">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea id="deskripsi" 
                                          ...
                                          rows="5"
                                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary"
                                          placeholder="Masukkan deskripsi produk"><?php echo htmlspecialchars($product['deskripsi']); ?></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="kategori" 
                                    ...
                                    <option value="Sambal" <?php echo $product['kategori'] === 'Sambal' ? 'selected' : ''; ?>>Sambal</option>
                                    <option value="Bumbu" <?php echo $product['kategori'] === 'Bumbu' ? 'selected' : ''; ?>>Bumbu</option>
                                    <option value="Paket" <?php echo $product['kategori'] === 'Paket' ? 'selected' : ''; ?>>Paket</option>
                                </select>
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                <div class="flex">
                                    ...
                                    <input type="number" 
                                           ...
                                           step="1000"
                                           class="flex-1 px-4 py-2 border border-gray-300 rounded-r-lg focus:ring-2 focus:ring-primary focus:border-primary"
                                           value="<?php echo $product['harga_reseller']; ?>"
                                           placeholder="20000">
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-primary transition-colors">
                                ...
                                <?php if ($product['foto']): ?>
                                    ...
                                    <div class="text-sm text-gray-600 mb-4">Foto Saat Ini</div>
                                <?php endif; ?>
                                
                                <div id="upload-placeholder" class="text-gray-500 <?php echo $product['foto'] ? 'hidden' : ''; ?>">
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 rounded-b-lg">
            <div class="flex justify-end space-x-3">
                <a href="manage_products.php" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
